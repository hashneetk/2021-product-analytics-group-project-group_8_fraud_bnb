...
def get_info(url, waiting_time=3, max_review=10):
    ...
    result : dict
        A dictionary with the following info:
            ...
            - beds (list of str): description of the number
    ...
    result = {
        ...
        'beds': [room.text for room in driver
    ...
    .find_element_by_css_selector('div._15pb00k').text

    review_url = driver
    .find_element_by_css_selector('div._19qg1ru a').get_attribute('href')
